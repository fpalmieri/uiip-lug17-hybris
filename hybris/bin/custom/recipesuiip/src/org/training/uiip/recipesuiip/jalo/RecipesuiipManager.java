 ...
 *  
 */
package org.training.uiip.recipesuiip.jalo;
...
import org.training.uiip.recipesuiip.constants.RecipesuiipConstants;



/**
 * This is the extension manager of the Recipesuiip extension.
 */
public class RecipesuiipManager extends GeneratedRecipesuiipManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(RecipesuiipManager.class.getName());
	 ...
	 */
	public static RecipesuiipManager getInstance()
	{
		return (RecipesuiipManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				RecipesuiipConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public RecipesuiipManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of RecipesuiipManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of RecipesuiipManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of RecipesuiipManager called, current tenant: " + getTenant().getTenantID());
		}
	}
